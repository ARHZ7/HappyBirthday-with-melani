...
new TypeIt("#teks2", {
  strings: ["Dengan ataupun tanpaku, semoga dunia selalu membahagiakan kamu bagimanapun caranya.", " ", "Terima kasih sudah bertahan sampai sejauh ini Melani.", " ", "- Wish all you the best"],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
